...
import {
  CreateVenueWrapper,
  CreateVenueForm,
} from "../CreateVenue/CreateVenue.styles";
    ...
    if (isSuccessfullUpdate === true) {
      ...
      return (
        <div className="error-update-message" ref={successMessageRef}>
          <p>
            Oops! An error occured while trying to update your venue. Please try
            again.
          </p>
        </div>
      );
    ...
    <CreateVenueWrapper>
      <div className="create-venue-container">
        ...
        <CreateVenueForm onSubmit={onUpdateVenueFormSubmit}>
          ...
          <VenueFormSubmitButton type="submit">
            Update Venue
          </VenueFormSubmitButton>
          {SuccessfullUpdate()}
        </CreateVenueForm>
      </div>
    </CreateVenueWrapper>
