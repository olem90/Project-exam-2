...
export const SpecificVenue = () => {
  ...
  const ownerPlaceholderImg =
    "https://images.rawpixel.com/image_1300/czNmcy1wcml2YXRlL3Jhd3BpeGVsX2ltYWdlcy93ZWJzaXRlX2NvbnRlbnQvbHIvdjI5MS1iYXRjaDUtbnVub29uLTQwLWJlYXV0eV8yLmpwZw.jpg";
  return (
        ...
        {venue ? (
          <SpecificVenueStyles>
            ...
            <div className="img-and-description-container">
              <div
                className={`specific-venue-name-img ${
                  !isCarouselVisible ? "specific-venue-with-no-carousel" : ""
                }`}
              >
                {venue.media && venue.media.length > 0 ? (
                  <img
                    className={`main-img ${
                      !isCarouselVisible ? "main-img-with-no-carousel" : ""
                    }`}
                    src={venue.media[activeImageIndex]}
                    alt="venue"
                    onError={(event) => {
            ...
            <div className="venue-content">
              <div
                className={`price-container ${
                  isCarouselVisible ? "price-container-carousel" : ""
                }`}
              >
                ...
                <div className="owner-img-container">
                  {venue.owner.avatar && venue.owner.avatar.length > 0 ? (
                    <img
                      ...
                      onError={(event) => {
                        event.target.onerror = null;
                        event.target.src = ownerPlaceholderImg;
                      }}
                    />
                  ) : (
                    <img
                      src={ownerPlaceholderImg}
                      alt="Placeholder image"
                    ></img>
                  )}
                </div>
