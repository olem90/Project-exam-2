          ...
          <SpecificVenueStyles>
            ...
            <div className="img-and-description-container">
              ...
              >
                {managerVenue.media && managerVenue.media.length > 0 ? (
                  <img
                    className="main-img"
                    src={managerVenue.media[activeImageIndex]}
                    alt="venue"
                    onError={(event) => {
            ...
            <div className="venue-content">
              ...
              <div className="update-venue-buttons-container">
                <UpdateVenueButton onClick={() => goToUpdateVenuePage(id)}>
                  Update Venue
                </UpdateVenueButton>
                <RemoveVenue />
              </div>
                ...
                <div className="facilities-container">
                  ...
                  <div className="icons-container">
                    <div>
                      ...
                      <span>Wifi:</span>
                      {managerVenue.meta.wifi ? " Yes" : " No"}
                    </div>

                    <div>
                      <FontAwesomeIcon className="parking-icon" icon={faCar} />
                      <span>Parking:</span>
                      {managerVenue.meta.parking ? " Yes" : " No"}
                    </div>
                    ...
                    <div>
                      ...
                      />
                      <span>Breakfast:</span>
                      {managerVenue.meta.breakfast ? " Yes" : " No"}
                    </div>

                    <div>
                      <FontAwesomeIcon className="pets-icon" icon={faPaw} />
                      <span>Pets:</span>
                      {managerVenue.meta.pets ? " Yes" : " No"}
                    </div>
                  </div>
                </div>
              </div>
