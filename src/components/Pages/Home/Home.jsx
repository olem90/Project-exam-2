...
export const Home = () => {
    ...
    return(
        <HomeStyles>
            <SearchBar filteredVenues={filteredVenues} setFilteredVenues={setFilteredVenues} venues={venues} />
            <VenueCards isLoading={isLoading} venues={filteredVenues} filteredVenues={filteredVenues} isError={isError} />
        </HomeStyles>
    )
}
