...
export const UsersVenueBookings = ({ id }) => {
  ...
  if (isError) {
    return (
      <div>
        Oops looks like an error has occured while loading venue bookings.
        Please try again.
      </div>
    );
  }
            ...
            return (
              <VenueBookingsCards key={booking.id}>
                ...
                <div className="user-venue-booking-img-container">
                  <img
                    className="user-venue-bookings-img"
                    src={venueBookings.media} alt="venue image"
                  ></img>
                </div>
              </VenueBookingsCards>
            );
