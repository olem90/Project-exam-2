          ...
          <VenueCardsStyles key={venue.id}>
            ...
            <div className="venue-card-info">
              <div className="city-and-country-container">
                <span>
                  Country: <span>{venue.location.country}</span>
                </span>
                <span>
                  City: <span>{venue.location.city}</span>
                </span>
              </div>

              <div className="price-guests-container">
                <span>
                  Price: <span className="venue-price">${venue.price}</span>
                </span>
                <span>
                  Max guests:{" "}
                  <span className="venue-max-guests">{venue.maxGuests}</span>
                </span>
              </div>
            </div>
            <ViewVenueButton onClick={() => goToVenuePage(venue.id)}>
              View venue
            </ViewVenueButton>
          </VenueCardsStyles>
        ))}
